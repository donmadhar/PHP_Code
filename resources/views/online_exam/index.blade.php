                    ...
                    <form class="pt-3 mt-6" id="create-form" method="POST" action="{{ route('online-exam.store') }}">
                        ...
                        <div class="class_container" style="display : none">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="number" id="online-exam-duration" name="duration_class" min="1" placeholder="{{ __('duration') }}" class="form-control"  />
                                </div>
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="datetime-local" id="online-exam-start-date" min="{{date('Y-m-d h:i')}}" name="start_date_class" placeholder="{{__('start_date')}}" class='form-control' >
                                </div>
                                <div class="form-group col-md-2">
                        ...
                        <div class="class_section_container">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                    <label>{{ __('start_date')}} <span class="text-danger">*</span></label>
                                    <input type="datetime-local" id="online-exam-start-date" min="{{date('Y-m-d h:i')}}" name="start_date_class_section" placeholder="{{__('start_date')}}" class='form-control' >
                                </div>
                                <div class="form-group col-md-2">
                                    <label>{{ __('end_date') }} <span class="text-danger">*</span></label>
                                    <input type="datetime-local" id="online-exam-end-date" min="{{date('Y-m-d h:i')}}" name="end_date_class_section" placeholder="{{ __('end_date')}}" class='form-control' >
                                </div>
                            </div>
                        </div>
