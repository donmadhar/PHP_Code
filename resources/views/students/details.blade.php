                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    {!! Form::tel('mobile', null, ['placeholder' => __('mobile'), 'min' => 1 , 'class' => 'form-control', 'id' => 'edit_mobile']) !!}
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label>{{ __('father') . ' ' . __('mobile') }} <span
                                            class="text-danger">*</span></label>
                                    {!! Form::text('father_mobile', null, ['placeholder' => __('father') . ' ' . __('mobile'), 'class' => 'form-control', 'min' => 1  ,'id' => 'edit_father_mobile', 'readonly' => true]) !!}
                                </div>
                                <div class="form-group col-sm-12 col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label>{{ __('mother') . ' ' . __('mobile') }} <span
                                            class="text-danger">*</span></label>
                                    {!! Form::text('mother_mobile', null, ['placeholder' => __('mother') . ' ' . __('mobile'), 'class' => 'form-control', 'min' => 1  ,'id' => 'edit_mother_mobile', 'readonly' => true]) !!}
                                </div>
                                <div class="form-group col-sm-12 col-md-4">
                            ...
                            <div class="row" id="edit_guardian_div" style="display:none;">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label>{{ __('guardian') . ' ' . __('mobile') }} <span
                                            class="text-danger">*</span></label>
                                    {!! Form::text('guardian_mobile', null, ['placeholder' => __('guardian') . ' ' . __('mobile'), 'class' => 'form-control', 'min' => 1  ,'id' => 'edit_guardian_mobile', 'readonly' => true]) !!}
                                </div>
                                <div class="form-group col-sm-12 col-md-12">
                                    <label>{{ __('gender') }} <span class="text-danger">*</span></label><br>
                                    <div class="d-flex">
